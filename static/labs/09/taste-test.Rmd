...
1. Record below any changes that you made to your experimental protocol.

2. Create a data frame based on the data you collected and print out into your pdf. You can print all rows your data frame using `print(my_tibble, n = nrow(my_tibble))`.
